...
class emailService {
  ...
  async sendTemplatedMessage(msg) {
    if (!msg || typeof msg.toJSON !== 'function' || typeof msg.templateName !== 'string' || typeof msg.templateValues !== 'object') {
      throw new Error('Message must implement toJSON(), have a templateName (string), and templateValues (object)');
    }
    var requestBody = {
      data: {
