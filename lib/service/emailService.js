...
class emailService {
  ...
  async getEmailDisposition(sourceTrackingId) {
    var _response$data, _response$data$messag, _response$data$messag2;
    ...
    if (
      (response === null || response === void 0
        ...
        ? void 0
        : (_response$data$messag = _response$data.message) === null ||
          _response$data$messag === void 0
        ? void 0
        : (_response$data$messag2 = _response$data$messag.message_deliveries) === null ||
          _response$data$messag2 === void 0
        ? void 0
        : _response$data$messag2.length) > 0
    ) {
